      ...
      <main className="project-page">
        ...
        <header className="project-detail-hero">
          ...
          <div className="detail-score-panel">
            ...
            <div className="detail-stat"><span>★ {formatNumber(project.stars)}</span><span className="trend-up">今日 +{formatNumber(project.starsToday)}</span></div>
          </div>
        </header>
        ...
        <section className="project-detail-grid">
          ...
          <aside className="detail-sidebar">
            ...
            <div className="fact-grid"><p><span>语言</span>{project.language}</p><p><span>许可证</span>{project.license}</p><p><span>趋势</span>{project.trend}</p><p><span>采集时间</span>{project.capturedAt}</p></div>
          </aside>
        </section>
      </main>
    </div>
